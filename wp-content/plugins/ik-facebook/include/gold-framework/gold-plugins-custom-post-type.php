	...
	function setupCustomFields($fields)
	{
		...
		foreach ($fields as $f)
		{
			...
			(
				...
				"readonly"		=> !empty($f['readonly']) ? $f['readonly'] : false
			);
		}
			...
			foreach ( $this->customFields as $customField ) {
				...
				if ( $output ) { ?>
					<div class="form-field form-required">
						<?php
						$readonly = $customField['readonly'] ? 'readonly="readonly"' : '';
						
						switch ( $customField[ 'type' ] ) {
							case "checkbox": {
								// Checkbox
								echo '<label for="' . $this->prefix . $customField[ 'name' ] .'" style="display:inline;"><b>' . $customField[ 'title' ] . '</b></label>&nbsp;&nbsp;';
								echo '<input '.$readonly.' type="checkbox" name="' . $this->prefix . $customField['name'] . '" id="' . $this->prefix . $customField['name'] . '" value="yes"';
