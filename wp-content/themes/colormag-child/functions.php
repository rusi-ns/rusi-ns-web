...
function colormag_footer_copyright() {
   ...
   $default_footer_value = sprintf( __( 'Patron: His Honour, The Honourable Arthur J. LeBlanc, ONS, QC, Lieutenant Governor of Nova Scotia.<br/> Copyright &copy; %1$s %2$s. All rights 
reserved.', 'colormag' 
), 
date( 'Y' ), $site_link );
